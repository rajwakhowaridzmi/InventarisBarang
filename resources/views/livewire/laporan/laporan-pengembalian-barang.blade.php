                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <button class="btn btn-primary" wire:click="exportPDF"><i class="bi bi-file-earmark-pdf-fill"></i> Export PDF</button>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $pengembalians->peminjaman->siswa->nama ?? '-' }}
                                            </td>
                                            <td>{{ $pengembalians->peminjaman->siswa->kelas->tingkat ?? '-' }}
