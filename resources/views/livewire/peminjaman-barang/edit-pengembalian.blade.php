                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="update">
                                <div class="row mb-3">
                                    <label for="pengembalian_id" class="col-sm-2 col-form-label">ID Pengembalian</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="pengembalian_id" value="{{ $pengembalian_id }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="kembali_status" class="col-sm-2 col-form-label">Status Kembali</label>
                                    <div class="col-sm-10">
                                        <select class="form-select" id="kembali_status" wire:model="kembali_status">
                                            <option selected="">Tentukan Kondisi</option>
                                            <option value="0">Belum Dikembalikan</option>
                                            <option value="1">Dikembalikan</option>
                                        </select>
                                        @error('kembali_status')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
