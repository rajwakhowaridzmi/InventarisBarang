                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form wire:submit.prevent="update">
                                            <div class="row mb-3">
                                                <label for="jns_brg_kode" class="col-sm-2 col-form-label">Jenis Barang Kode</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="jns_brg_kode" wire:model="jns_brg_kode" readonly>
                                                    @error('jns_brg_kode')
