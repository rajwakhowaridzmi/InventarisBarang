                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a wire:click="confirmDelete({{ $jurusans->jurusan_id }})" class="bi bi-trash fs-3 cursor-pointer" data-bs-toggle="modal" data-bs-target="#konfirmasiHapusModal"></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
            ...
            <div class="modal-dialog modal-md" style="margin-top: 150px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-center gap-1">
                        ...
                        <button type="button" class="btn btn-primary flex-fill" wire:click="delete({{ $jurusan_id }})">Hapus</button>
                    </div>
                </div>
            </div>
        </div>
